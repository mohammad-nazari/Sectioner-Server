...
class __declspec(dllexport)BaseConverter
{
public:
	std::string GetSourceBaseSet() const
	{
		return sourceBaseSet_;
	}
	std::string GetTargetBaseSet() const
	{
		return targetBaseSet_;
	}
	unsigned int GetSourceBase() const
	{
		return static_cast<unsigned int>(sourceBaseSet_.length());
	}
	unsigned int GetTargetBase() const
	{
		return static_cast<unsigned int>(targetBaseSet_.length());
	}
